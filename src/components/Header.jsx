    ...
    return (
        <div className='fixed top-0 left-0 w-full z-50 bg-white'>
            <div className='flex items-center justify-between gap-4 py-3 sm:px-12 px-3'>
                ...
                {/* Auth buttons */}
                {currentUser ? <Link to="/dashboard/" className='mmd:flex hidden  text-white rounded-lg text-[16px]'>
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <p className="flex flex-col text-[#0A0A0A] mmd:text-[16px] text-2.5 font-medium ">
                            <span className=" text-[#737373]  mmd:text-[12px] text-[8px] font-normal ">
                                welcome,
                            </span>
                    ...
                    : <section className='mmd:flex flex-1 hidden items-center justify-end gap-4 '>
                ...
                <section className='flex mmd:hidden items-center gap-4 w-fit' onClick={() => setNav(!nav)}>
